            ...
            <div>
                <main className="mx-auto container m-3">
                    <article className="mx-auto accessibilityDiv">
                        ...
                        <h2 className="p-2">Innehåll som inte är tillgängligt</h2>
                        <p className="p-2">
                            <strong>Respektera användarens inställningar</strong>
                            <br /> Inga inställningar kan anpassas efter användarens önskemål
                        </p>
