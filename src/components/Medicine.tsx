...
const addMedicine= async (e: FormEvent<HTMLFormElement>) => {
  ...
  try {
      const response = await fetch(`http://localhost:8000/api/medicines/animals/${chosenAnimalId}`, {
          method: "POST",
          headers: {
         ...
         <form
            ...
            >
                ...
                <div className="form-check">
                  ...
                  <label htmlFor="recurrent-true" className="form-label">
                        Ja
                    </label>
                        <input
                        type="radio"
...
<label htmlFor="recurrent-false" className="form-label">
                        Nej
                    </label>
                    <input
                        type="radio"
            ...
            <h2>Senaste medcieineringarna:</h2>
                ...
                <tbody>
                    {medicines.map((medicine) => (
                        <tr key={medicine.id}>
                            ...
                            <td>{medicine.date} Kg</td>
                            <td>{medicine.type}</td>
                            <td>{medicine.amount}</td>
                            <td>{medicine.recurrent}</td>
